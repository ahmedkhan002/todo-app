  ...
  return (
    <Zoom in={true} timeout={400}>
      <div className="flex flex-col gap-6 items-center w-full my-10 px-4 pt-4">
        ...
        <Slide in={true} direction="up" timeout={700}>
          <div className="hidden max-lg:flex flex-row justify-center max-sm:gap-5 flex-wrap gap-10 text-white font-semibold">
            <button
              ...
              className={`w-[100px] h-12 rounded-xl transition-all duration-300 hover:scale-105 bg-lime-500 ${
            ...
            <button
              ...
              className={`w-[100px] h-12 rounded-xl transition-all duration-300 hover:scale-105 bg-blue-600 ${
            ...
            <button
              ...
              className={`w-[100px] h-12 rounded-xl transition-all duration-300 hover:scale-105 bg-red-600 ${
            ...
            <button
              ...
              className={`w-[100px] h-12 rounded-xl transition-all duration-300 hover:scale-105 bg-gray-600 ${
        ...
        {isActive !== null && (
          <Zoom in={true} timeout={400}>
            <div className="relative w-full overflow-hidden my-2 gap-5 z-100 flex justify-center">
              <div
                className="flex justify-center items-center cursor-pointer border-1 rounded-2xl hover:text-white hover:bg-blue-600 text-blue-600 transition-all w-20 px-5 font-semibold my-2 h-10"
                onClick={handleActionDone}
              >
                {isActive === 'History' ? 'Delete' : 'Done'}
              </div>
              <div
                className="flex justify-center items-center cursor-pointer border-1 rounded-2xl hover:text-white hover:bg-red-600 text-red-600 transition-all w-20 px-5 font-semibold my-2 h-10"
                onClick={() => dispatch(activebutton(null))}
              >
                Cancel
              </div>
            </div>
                ...
                <Table stickyHeader>
                  ...
                  <TableBody>
                    {(isActive === 'History' ? history : todoitem).map((item, i) => (
                      <Zoom in={true} timeout={400} key={i}>
                        <TableRow className={`${item.completed === true ? 'line-through' : ''}`}>
                          {isActive !== null && (
                            <TableCell padding="checkbox">
                              <Grow in={true} timeout={400}>
                                <Checkbox
                                  checked={item.selected || false}
                                  onChange={() => dispatch(toggleSelected(i))}
                                />
                              </Grow>
                            </TableCell>
                          )}
